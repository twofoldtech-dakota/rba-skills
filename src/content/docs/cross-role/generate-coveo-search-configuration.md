...
- [Configure Sitecore Search](/technologies/sitecore/search/configure-sitecore-search/) — For native Sitecore Search as an alternative to Coveo
- [Scaffold Commerce Catalog](/technologies/sitecore/commerce/scaffold-commerce-catalog/) — The catalog structure that Coveo indexes for product search
