...
- [Explain a Skill](/cross-role/explain-a-skill/) — Get a plain-language explanation of any Claude Code skill
- [Generate Project Brief](/roles/strategy/project-management/generate-project-brief/) — Research findings often inform project scope
