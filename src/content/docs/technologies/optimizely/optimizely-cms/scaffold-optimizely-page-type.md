...
- [Audit Content Model](/roles/strategy/content-strategy/audit-content-model/) — Audit existing content types before adding new page types
- [Generate Design System Documentation](/roles/design/ui-design/generate-design-system-docs/) — Align page type rendering with the project's design system
