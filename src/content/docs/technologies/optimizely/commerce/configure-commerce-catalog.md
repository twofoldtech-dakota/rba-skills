...
- [Scaffold OrderCloud Integration](/technologies/sitecore/commerce/scaffold-ordercloud-integration/) — Alternative commerce approach using Sitecore OrderCloud
- [Generate API Specification](/roles/engineering/software-engineering/back-end/generate-api-specification/) — Define APIs between the commerce engine and front-end
