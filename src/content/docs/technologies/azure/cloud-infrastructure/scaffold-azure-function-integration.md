...
- [Scaffold Azure PaaS Architecture](/technologies/azure/cloud-infrastructure/scaffold-azure-paas-architecture/) — The Azure infrastructure that hosts the function
- [Create Integration Spec](/roles/engineering/architecture/create-integration-spec/) — The integration spec that defines the data flow and contracts
- [Scaffold Azure DevOps Pipeline](/technologies/azure/cloud-infrastructure/scaffold-azure-devops-pipeline/) — CI/CD pipeline for deploying the function
