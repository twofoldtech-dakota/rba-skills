...
- [Security Review Checklist](/roles/security-oversight/security/security-review-checklist/) — Validate the deployed infrastructure against security requirements
- [Audit Sitecore XP Configuration](/technologies/sitecore/xp/audit-sitecore-xp-config/) — For Sitecore-specific hosting configurations on Azure
