...
- [Scaffold React Component](/roles/engineering/software-engineering/front-end/scaffold-react-component/) — Build front-end components that consume the Heartcore API
- [Generate API Specification](/roles/engineering/software-engineering/back-end/generate-api-specification/) — Document the API contract between Heartcore and the front-end
