...
- [Scaffold Sitecore JSS Component](/roles/engineering/architecture/scaffold-sitecore-jss-component/) — For JSS components on Sitecore XP, or when you need tests and Storybook stories alongside the component
- [Scaffold React Component](/roles/engineering/software-engineering/front-end/scaffold-react-component/) — For pure React components without Sitecore datasource dependencies
