...
- [Scaffold Sitecore JSS Component](/roles/engineering/architecture/scaffold-sitecore-jss-component/) — Build the CMS-managed components that wrap commerce storefront elements
- [Generate API Specification](/roles/engineering/software-engineering/back-end/generate-api-specification/) — Document the middleware API layer for team onboarding and integration testing
