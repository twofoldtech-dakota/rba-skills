...
- [Decompose Epic into Stories](/communicate/internal/decompose-epic-into-stories/) — Break a full epic into multiple tickets
- [Generate Feature Specification](/plan/discovery-and-requirements/generate-feature-specification/) — When the ticket needs a full spec before writing stories
