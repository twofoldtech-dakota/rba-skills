...
- [Generate Weekly Status Report](/plan/sprint-ceremonies/generate-weekly-status-report/) — Status reports draw from accumulated meeting notes and action items
- [Draft Client Communication](/communicate/client-facing/draft-client-communication/) — Send meeting follow-ups as professional client communications
