...
- [Generate Coveo Search Configuration](/communicate/enablement/generate-coveo-search-configuration/) — Full Coveo source and pipeline configuration (broader than just the search page)
- [Scaffold Sitecore JSS Component](/build/component-development/scaffold-sitecore-jss-component/) — Scaffold the Next.js component that wraps the Coveo search interface
- [Configure Umbraco Content Delivery API](/build/platform-configuration/configure-umbraco-content-delivery-api/) — Content Delivery API provides the content that Coveo indexes
