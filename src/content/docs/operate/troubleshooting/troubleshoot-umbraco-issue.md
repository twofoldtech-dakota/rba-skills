...
- [Plan Umbraco Version Migration](/plan/change-and-transition/plan-umbraco-version-migration/) — Many issues stem from incomplete migration — check the migration plan
- [Scaffold Umbraco Document Type](/build/component-development/scaffold-umbraco-document-type/) — Properly scaffolded document types prevent common issues
