...
- [Scaffold Optimizely Page Type](/build/component-development/scaffold-optimizely-page-type/) — Properly scaffolded types prevent common issues
- [Plan Episerver Migration](/plan/change-and-transition/plan-episerver-migration/) — Many issues stem from incomplete migration patterns
