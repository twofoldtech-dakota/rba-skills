...
- [Scaffold Azure PaaS Architecture](/build/architecture-and-integration/scaffold-azure-paas-architecture/) — The infrastructure the pipeline deploys to
- [Generate Go-Live Checklist](/operate/deployment-and-go-live/generate-go-live-checklist/) — The go-live checklist references the pipeline for deployment verification
- [Generate Knowledge Transfer Package](/operate/knowledge-transfer/generate-knowledge-transfer-package/) — Pipeline documentation is part of the KT package
