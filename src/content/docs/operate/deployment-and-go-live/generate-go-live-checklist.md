...
- [Generate Knowledge Transfer Package](/operate/knowledge-transfer/generate-knowledge-transfer-package/) — Post-launch, transition operational knowledge to the managed services team
- [Draft Managed Services Transition Plan](/plan/change-and-transition/draft-managed-services-transition/) — The go-live checklist feeds into the managed services transition
- [Guide Incident Response](/test-and-review/compliance-and-security/guide-incident-response/) — If something goes wrong during launch, follow the incident response process
