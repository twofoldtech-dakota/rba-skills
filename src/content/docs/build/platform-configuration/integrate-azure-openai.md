...
- [Research Any Topic](/communicate/enablement/research-any-topic/) — Research AI patterns and best practices before designing the integration
- [Configure Sitecore Search](/build/platform-configuration/configure-sitecore-search/) — For Sitecore-specific search implementations that could be enhanced with AI
