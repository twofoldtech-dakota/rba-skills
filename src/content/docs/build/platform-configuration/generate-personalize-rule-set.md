...
- [Plan XP-to-XM Cloud Migration](/plan/change-and-transition/plan-xp-to-xm-cloud-migration/) — Migrating xDB personalization rules to CDP/Personalize
- [Generate Personalization Experience Map](/build/design-systems/generate-personalization-experience-map/) — Design-level personalization touchpoint mapping
