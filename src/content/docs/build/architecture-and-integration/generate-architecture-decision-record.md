...
- [Generate Knowledge Transfer Package](/operate/knowledge-transfer/generate-knowledge-transfer-package/) — ADRs feed into the architecture decisions section of KT packages
- [Review Pull Request](/test-and-review/code-review/review-pull-request/) — PRs should reference relevant ADRs when implementing architectural decisions
