...
- [Generate Component Specification](/build/design-systems/generate-component-specification/) — The design spec that defines the component before scaffolding
- [Generate Unit Tests for Component](/test-and-review/testing/generate-unit-tests/) — Additional test coverage beyond the package scaffold
- [Scaffold Multi-Site Architecture](/build/architecture-and-integration/scaffold-multi-site-architecture/) — Multi-site architectures that share component packages
