...
- [Audit WCAG Compliance](/test-and-review/auditing/audit-wcag-compliance/) — The audit that produces the findings this skill remediates
- [Generate Component Specification](/build/design-systems/generate-component-specification/) — Component specs that include accessibility requirements
