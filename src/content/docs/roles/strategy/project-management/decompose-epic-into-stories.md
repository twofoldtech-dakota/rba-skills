...
- [Generate Feature Specification](/roles/strategy/business-analysis/generate-feature-specification/) — The spec that feeds this decomposition
- [Generate Three-Pillar Kickoff](/roles/strategy/project-management/generate-three-pillar-kickoff/) — The kickoff that establishes the sprint cadence
- [Generate Weekly Status Report](/roles/strategy/project-management/generate-weekly-status-report/) — Track the sprint progress from these stories
