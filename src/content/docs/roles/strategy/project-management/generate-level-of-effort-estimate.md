...
- [Draft SOW Scope Section](/roles/strategy/project-management/draft-sow-scope-section/) — The estimate feeds directly into the SOW
- [Decompose Epic into Stories](/roles/strategy/project-management/decompose-epic-into-stories/) — Break the estimated scope into sprint-ready stories
- [Assess Change Impact](/roles/strategy/project-management/assess-change-impact/) — Estimate the effort impact of a change request
