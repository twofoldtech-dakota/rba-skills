...
- [Generate Project Brief](/roles/strategy/project-management/generate-project-brief/) — The brief that precedes this kickoff
- [Generate Weekly Status Report](/roles/strategy/project-management/generate-weekly-status-report/) — The recurring report that starts after kickoff
- [Decompose Epic into Stories](/roles/strategy/project-management/decompose-epic-into-stories/) — Break the scope into sprint-ready stories after kickoff
