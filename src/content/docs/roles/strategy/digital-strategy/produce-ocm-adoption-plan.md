...
- [Audit CMS Author Experience](/roles/design/ux-design/audit-cms-author-experience/) — Improve the CMS UX to reduce adoption friction
- [Generate Three-Pillar Kickoff](/roles/strategy/project-management/generate-three-pillar-kickoff/) — Establish the OCM workstream during project kickoff
