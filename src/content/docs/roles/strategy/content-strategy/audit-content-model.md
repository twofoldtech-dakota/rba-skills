...
- [Generate Project Brief](/roles/strategy/project-management/generate-project-brief/) — The brief often references the content model scope
- [Scaffold Sitecore JSS Component](/roles/engineering/architecture/scaffold-sitecore-jss-component/) — Use audit findings to inform component scaffolding
