...
- [Generate Requirements Document](/roles/strategy/business-analysis/generate-requirements-document/) — For project-level requirements, not individual features
- [Generate Component Specification](/roles/design/ui-design/generate-component-specification/) — Hand off the UI portion of the feature to design with a component spec
- [Generate Test Plan](/roles/engineering/testing-qa/generate-test-plan/) — Generate the test plan that validates this specification
