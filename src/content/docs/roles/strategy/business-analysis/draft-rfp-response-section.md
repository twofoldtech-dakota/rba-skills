...
- [Assess DXP Platform Fit](/roles/strategy/digital-strategy/assess-dxp-platform-fit/) — Platform comparison analysis that supports RFP technology recommendations
- [Generate Level of Effort Estimate](/roles/strategy/project-management/generate-level-of-effort-estimate/) — The estimate that backs the RFP's pricing section
- [Draft SOW Scope Section](/roles/strategy/project-management/draft-sow-scope-section/) — If you win the RFP, the scope section comes next
