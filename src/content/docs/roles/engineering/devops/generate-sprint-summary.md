...
- [Generate Project Brief](/roles/strategy/project-management/generate-project-brief/) — Sprint summaries should reference the original brief's objectives
- [Research Any Topic](/cross-role/research-any-topic/) — Research context for blockers or technical decisions mentioned in the summary
