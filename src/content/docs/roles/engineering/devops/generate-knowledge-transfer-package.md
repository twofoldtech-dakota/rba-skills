...
- [Draft Managed Services Transition](/roles/strategy/project-management/draft-managed-services-transition/) — The transition plan this KT package supports
- [Generate Architecture Decision Record](/roles/engineering/architecture/generate-architecture-decision-record/) — Individual ADRs that feed into the architecture decisions section
