...
- [Generate API Specification](/roles/engineering/software-engineering/back-end/generate-api-specification/) — Define the API contract for any custom middleware layer in the integration
- [Security Review Checklist](/roles/security-oversight/security/security-review-checklist/) — Review authentication flows, secret management, and data handling in the integration
