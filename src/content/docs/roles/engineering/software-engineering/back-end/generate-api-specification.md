...
- [Security Review Checklist](/roles/security-oversight/security/security-review-checklist/) — Review the API's authentication, authorization, and input validation against OWASP standards
- [Generate Test Plan](/roles/engineering/testing-qa/generate-test-plan/) — Generate a test plan that covers every endpoint and error scenario defined in the spec
