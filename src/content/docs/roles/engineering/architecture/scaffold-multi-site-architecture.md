...
- [Configure XM Cloud Component](/technologies/sitecore/xm-cloud/configure-xm-cloud-component/) — Build shared XM Cloud components for multi-site use
- [Scaffold Commerce Catalog](/technologies/sitecore/commerce/scaffold-commerce-catalog/) — Multi-brand catalog architecture for commerce
