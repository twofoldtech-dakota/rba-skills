...
- [Generate Test Plan](/roles/engineering/testing-qa/generate-test-plan/) — Project-level test strategy that these unit tests implement
- [Generate Component Specification](/roles/design/ui-design/generate-component-specification/) — The spec that defines what behavior these tests should verify
- [Scaffold React Component](/roles/engineering/software-engineering/front-end/scaffold-react-component/) — Scaffold a component that this skill then tests
