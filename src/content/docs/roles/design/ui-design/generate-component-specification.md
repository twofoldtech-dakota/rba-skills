...
- [Generate Design System Docs](/roles/design/ui-design/generate-design-system-docs/) — Document the full design system this component belongs to
- [Generate Feature Specification](/roles/strategy/business-analysis/generate-feature-specification/) — The feature spec that defines the business requirements this component fulfills
- [Scaffold React Component](/roles/engineering/software-engineering/front-end/scaffold-react-component/) — Scaffold the actual component code from this spec
