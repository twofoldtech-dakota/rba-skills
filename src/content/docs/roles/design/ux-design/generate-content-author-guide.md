...
- [Audit CMS Author Experience](/roles/design/ux-design/audit-cms-author-experience/) — Audit the editorial interface before writing the guide — fix UX issues rather than documenting workarounds
- [Design CMS Content Model](/roles/strategy/content-strategy/design-cms-content-model/) — The content model defines the types the author guide documents
- [Generate Knowledge Transfer Package](/roles/engineering/devops/generate-knowledge-transfer-package/) — The author guide is one component of the full KT package
