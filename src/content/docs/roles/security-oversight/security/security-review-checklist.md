...
- [Core Web Vitals Audit](/roles/security-oversight/performance/core-web-vitals-audit/) — Performance and security reviews often overlap (e.g., CDN configuration)
- [Audit WCAG Compliance](/roles/design/accessibility/audit-wcag-compliance/) — Accessibility, security, and performance form the "non-functional trifecta"
