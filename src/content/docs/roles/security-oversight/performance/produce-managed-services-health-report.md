...
- [Draft Managed Services Transition](/roles/strategy/project-management/draft-managed-services-transition/) — The transition plan that established this managed services engagement
- [Core Web Vitals Audit](/roles/security-oversight/performance/core-web-vitals-audit/) — Deep-dive performance audit when health metrics show degradation
- [Guide Incident Response](/roles/security-oversight/security/guide-incident-response/) — Structured response for incidents that appear in the health report
