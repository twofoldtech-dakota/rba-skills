...
- [Audit Content Model](/build/content-modeling/audit-content-model/) — Review and document the CMS content model that the brief references
- [Generate Sprint Summary](/plan/sprint-ceremonies/generate-sprint-summary/) — Summarize progress once the project is underway
