...
- [Create Digital Roadmap](/plan/project-kickoff/create-digital-roadmap/) — Build the digital roadmap once the platform is selected
- [Map Content Migration](/build/content-modeling/map-content-migration/) — Plan the migration from the current platform to the chosen one
