...
- [Generate Requirements Document](/plan/discovery-and-requirements/generate-requirements-document/) — Turn discovery findings into formal requirements
- [Generate Feature Specification](/plan/discovery-and-requirements/generate-feature-specification/) — Spec individual features identified during discovery
- [Assess DXP Platform Fit](/plan/discovery-and-requirements/assess-dxp-platform-fit/) — Platform evaluation often runs parallel to discovery
