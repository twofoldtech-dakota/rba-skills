...
- [Generate Project Brief](/plan/project-kickoff/generate-project-brief/) — The project brief that establishes the milestones this report tracks
- [Assess Change Impact](/plan/change-and-transition/assess-change-impact/) — When a client request needs scope assessment before the next status report
- [Generate Sprint Summary](/plan/sprint-ceremonies/generate-sprint-summary/) — Engineering-focused sprint summary for internal use
