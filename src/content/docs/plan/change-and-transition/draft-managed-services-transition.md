...
- [Generate Knowledge Transfer Package](/operate/knowledge-transfer/generate-knowledge-transfer-package/) — The comprehensive KT package that feeds this transition
- [Produce Managed Services Health Report](/operate/performance/produce-managed-services-health-report/) — The monthly health report the managed services team produces
- [Guide Incident Response](/test-and-review/compliance-and-security/guide-incident-response/) — The incident response process used during managed services
