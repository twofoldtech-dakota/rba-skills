...
- [Audit Sitecore XP Config](/test-and-review/auditing/audit-sitecore-xp-config/) — Audit the current XP configuration before migration planning
- [Configure XM Cloud Component](/build/platform-configuration/configure-xm-cloud-component/) — Build the XM Cloud components that replace XP renderings
- [Scaffold JSS Component](/build/component-development/scaffold-sitecore-jss-component/) — Scaffold the JSS/Next.js components for the target architecture
