...
- [Generate Weekly Status Report](/plan/sprint-ceremonies/generate-weekly-status-report/) — Reflect the change request impact in the next status report
- [Decompose Epic into Stories](/communicate/internal/decompose-epic-into-stories/) — If approved, decompose the change into sprint-ready stories
